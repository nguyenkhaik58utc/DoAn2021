...
namespace iDAS.Web.Areas.Human.Controllers.Profile
{
 [SystemAuthorize(CheckAuthorize = false)]
    ...
    public class V3_ProfileWorkTrialController : BaseController
    {
        //
        // GET: /Human/ProfileWorkTrial/
        V3_HumanProfileWorkTrialAPI humanProfileWorkTrialAPI = new V3_HumanProfileWorkTrialAPI();
        ...
        public ActionResult Employee(int Id,int check)
        {
        ...
        public ActionResult GetDataEmployeeNotPaging(int EmployeeID)
        {
            var result = humanProfileWorkTrialAPI.GetByEmployeeID(EmployeeID).Result.Data;
