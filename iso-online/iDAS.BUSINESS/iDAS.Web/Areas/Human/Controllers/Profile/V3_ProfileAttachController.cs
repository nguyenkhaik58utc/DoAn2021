...
namespace iDAS.Web.Areas.Human.Controllers.Profile
{
 [SystemAuthorize(CheckAuthorize = false)]
    ...
    public class V3_ProfileAttachController : BaseController
    {
        ...
        #endregion
        public ActionResult LoadProfileAttachNotPaging(int EmployeeID)
        {
            var result = humanProfileAttachAPI.GetByEmployeeID(EmployeeID).Result.Data;
