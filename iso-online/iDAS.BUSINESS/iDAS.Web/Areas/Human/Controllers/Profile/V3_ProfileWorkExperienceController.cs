...
namespace iDAS.Web.Areas.Human.Controllers.Profile
{
    ...
    public class V3_ProfileWorkExperienceController : BaseController
    {
        private V3_HumanProfileWorkExperienceAPI v3_HumanProfileWorkExperienceAPI = new V3_HumanProfileWorkExperienceAPI();
        ...
        public ActionResult LoadProfileWorkExperienceNotPaging(int employeeId)
        {
            var result = v3_HumanProfileWorkExperienceAPI.GetByEmployeeID(employeeId).Result.Data;
