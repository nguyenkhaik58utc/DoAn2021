...
{
    public class V3_EducationTypeController : Controller
    {
        // GET: Human/V3_EducationType

        V3_EducationTypeAPI api = new V3_EducationTypeAPI();
        ...
        [HttpPost]
        public ActionResult Create(V3_EducationTypeResponse obj)
        {
            var success = false;
            try
            {
                ...
                {
                    api.Insert(obj);
                    X.GetCmp<Store>("StoreEducationType").Reload();
        ...
        [HttpPost]
        public ActionResult Update(V3_EducationTypeResponse objEdit)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        public ActionResult Delete(int ID)
        {
            try
            {
                ...
                {
                    Ultility.ShowMessageBox("Không thành công", "Hình thức đào tạo đang được sử dụng", MessageBox.Icon.ERROR);
                }
                return this.Direct();
            }
            catch (Exception ex)
