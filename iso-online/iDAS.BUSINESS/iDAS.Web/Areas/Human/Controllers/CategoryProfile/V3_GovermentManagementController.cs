...
{
    public class v3_GovermentManagementController : Controller
    {
        V3_GovermentManagementAPI api = new V3_GovermentManagementAPI();
        ...
        [HttpPost]
        public ActionResult Create(V3_GovermentManagementResponse obj)
        {
            var success = false;
            try
            {
                ...
                {
                    api.Insert(obj);
                    X.GetCmp<Store>("StoreGovermentManagement").Reload();
        ...
        [HttpPost]
        public ActionResult Update(V3_GovermentManagementResponse objEdit)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        public ActionResult Delete(int ID)
        {
            try
            {
                ...
                {
                    Ultility.ShowMessageBox("Không thành công", "Trình độ quản lý đang được sử dụng", MessageBox.Icon.ERROR);
                }
                return this.Direct();
            }
            catch (Exception ex)
