...
{
    public class V3_EducationFieldController : Controller
    {
        // GET: Human/V3_EducationField
        V3_EducationFieldAPI api = new V3_EducationFieldAPI();
        ...
        [HttpPost]
        public ActionResult Create(V3_EducationFieldResponse obj)
        {
            var success = false;
            try
            {
                ...
                {
                    api.Insert(obj);
                    X.GetCmp<Store>("StoreEducationField").Reload();
        ...
        [HttpPost]
        public ActionResult Update(V3_EducationFieldResponse objEdit)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        public ActionResult Delete(int ID)
        {
            try
            {
                ...
                {
                    Ultility.ShowMessageBox("Không thành công", "Chuyên ngành đào tạo đang được sử dụng", MessageBox.Icon.ERROR);
                }
                return this.Direct();
            }
            catch (Exception ex)
