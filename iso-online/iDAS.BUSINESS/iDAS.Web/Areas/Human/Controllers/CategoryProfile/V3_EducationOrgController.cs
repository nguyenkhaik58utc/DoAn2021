...
{
    public class V3_EducationOrgController : Controller
    {
        // GET: Human/V3_EducationOrg
        V3_EducationOrgAPI api = new V3_EducationOrgAPI();
        ...
        [HttpPost]
        public ActionResult Create(V3_EducationOrgResponse obj)
        {
            var success = false;
            try
            {
                ...
                {
                    api.Insert(obj);
                    X.GetCmp<Store>("StoreEducationOrg").Reload();
        ...
        [HttpPost]
        public ActionResult Update(V3_EducationOrgResponse objEdit)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        public ActionResult Delete(int ID)
        {
            try
            {
                ...
                {
                    Ultility.ShowMessageBox("Không thành công", "Cơ sở đào tạo đang được sử dụng", MessageBox.Icon.ERROR);
                }
                return this.Direct();
            }
            catch (Exception ex)
