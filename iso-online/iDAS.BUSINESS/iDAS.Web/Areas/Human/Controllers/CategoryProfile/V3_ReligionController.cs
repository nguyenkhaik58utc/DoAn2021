...
{
    public class V3_ReligionController : Controller
    {
        V3_ReligionAPI api = new V3_ReligionAPI();
        ...
        [HttpPost]
        public ActionResult Create(V3_ReligionResponse obj)
        {
            var success = false;
            try
            {
                ...
                {
                    api.Insert(obj);
                    X.GetCmp<Store>("StoreReligion").Reload();
        ...
        [HttpPost]
        public ActionResult Update(V3_ReligionResponse objEdit)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        public ActionResult Delete(int ID)
        {
            try
            {
                ...
                {
                    Ultility.ShowMessageBox("Không thành công", "Tôn giáo đang được sử dụng", MessageBox.Icon.ERROR);
                }
                return this.Direct();
            }
            catch (Exception ex)
