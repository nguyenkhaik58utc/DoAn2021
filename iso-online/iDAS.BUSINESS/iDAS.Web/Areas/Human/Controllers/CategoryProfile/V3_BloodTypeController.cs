...
{
    public class v3_BloodTypeController : Controller
    {
        V3_BloodTypeAPI api = new V3_BloodTypeAPI();
        ...
        [HttpPost]
        public ActionResult Create(V3_BloodTypeResponse obj)
        {
            var success = false;
            try
            {
                ...
                {
                    api.Insert(obj);
                    X.GetCmp<Store>("StoreBloodType").Reload();
        ...
        [HttpPost]
        public ActionResult Update(V3_BloodTypeResponse objEdit)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        public ActionResult Delete(int ID)
        {
            try
            {
                ...
                {
                    Ultility.ShowMessageBox("Không thành công", "Nhóm máu đang được sử dụng", MessageBox.Icon.ERROR);
                }
                return this.Direct();
            }
            catch (Exception ex)
