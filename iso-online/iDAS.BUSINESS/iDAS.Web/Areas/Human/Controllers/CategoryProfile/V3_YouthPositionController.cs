...
{
    public class V3_YouthPositionController : Controller
    {
        // GET: Human/V3_YouthPosition
        V3_YouthPositionAPI api = new V3_YouthPositionAPI();
        ...
        [HttpPost]
        public ActionResult Create(V3_YouthPositionResponse obj)
        {
            var success = false;
            try
            {
                ...
                {
                    api.Insert(obj);
                    X.GetCmp<Store>("StoreYouthPosition").Reload();
        ...
        [HttpPost]
        public ActionResult Update(V3_YouthPositionResponse objEdit)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        public ActionResult Delete(int ID)
        {
            try
            {
                ...
                {
                    Ultility.ShowMessageBox("Không thành công", "Chức vụ đoàn thanh niên đang được sử dụng", MessageBox.Icon.ERROR);
                }
                return this.Direct();
            }
            catch (Exception ex)
