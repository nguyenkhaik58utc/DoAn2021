...
{
    public class V3_EducationLevelController : Controller
    {
        // GET: Human/V3_EducationLevel
        V3_EducationLevelAPI api = new V3_EducationLevelAPI();
        ...
        [HttpPost]
        public ActionResult Create(V3_EducationLevelResponse obj)
        {
            var success = false;
            try
            {
                ...
                {
                    api.Insert(obj);
                    X.GetCmp<Store>("StoreEducationLevel").Reload();
        ...
        [HttpPost]
        public ActionResult Update(V3_EducationLevelResponse objEdit)
        {
            try
            {
                if (ModelState.IsValid)
