...
{
    public class V3_CertificateTypeController : Controller
    {
        // GET: Human/V3_CertificateType
        V3_CertificateTypeAPI api = new V3_CertificateTypeAPI();
        ...
        [HttpPost]
        public ActionResult Create(V3_CertificateTypeResponse obj)
        {
            var success = false;
            try
            {
                ...
                {
                    api.Insert(obj);
                    X.GetCmp<Store>("StoreCertificateType").Reload();
        ...
        [HttpPost]
        public ActionResult Update(V3_CertificateTypeResponse objEdit)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        public ActionResult Delete(int ID)
        {
            try
            {
                ...
                {
                    Ultility.ShowMessageBox("Không thành công", "Loại chứng chỉ đang được sử dụng", MessageBox.Icon.ERROR);
                }
                return this.Direct();
            }
            catch (Exception ex)
