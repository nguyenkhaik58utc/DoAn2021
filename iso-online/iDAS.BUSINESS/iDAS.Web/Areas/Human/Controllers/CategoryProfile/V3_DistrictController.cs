...
{
    public class V3_DistrictController : Controller
    {
        V3_DistrictAPI api = new V3_DistrictAPI();
        ...
        [HttpPost]
        public ActionResult Create(V3_DistrictResponse obj)
        {
            var success = false;
            try
            {
                ...
                {
                    api.Insert(obj);
                    X.GetCmp<Store>("StoreDistrict").Reload();
        ...
        [HttpPost]
        public ActionResult Update(V3_DistrictResponse objEdit)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        public ActionResult Delete(int ID)
        {
            try
            {
                ...
                {
                    Ultility.ShowMessageBox("Không thành công", "Quận/Huyện đang được sử dụng", MessageBox.Icon.ERROR);
                }
                return this.Direct();
            }
            catch (Exception ex)
