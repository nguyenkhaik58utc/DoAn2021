...
{
    public class v3_PoliticalTheoryController : Controller
    {
        V3_PoliticalTheoryAPI api = new V3_PoliticalTheoryAPI();
        ...
        [HttpPost]
        public ActionResult Create(V3_PoliticalTheoryResponse obj)
        {
            var success = false;
            try
            {
                ...
                {
                    api.Insert(obj);
                    X.GetCmp<Store>("StorePoliticalTheory").Reload();
        ...
        [HttpPost]
        public ActionResult Update(V3_PoliticalTheoryResponse objEdit)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        public ActionResult Delete(int ID)
        {
            try
            {
                ...
                {
                    Ultility.ShowMessageBox("Không thành công", "Trình độ lý luận chính trị đang được sử dụng", MessageBox.Icon.ERROR);
                }
                return this.Direct();
            }
            catch (Exception ex)
