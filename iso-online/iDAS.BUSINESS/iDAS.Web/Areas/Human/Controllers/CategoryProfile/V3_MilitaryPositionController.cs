...
{
    public class V3_MilitaryPositionController : Controller
    {
        // GET: Human/V3_MilitaryPosition
        V3_MilitaryPositionAPI api = new V3_MilitaryPositionAPI();
        ...
        [HttpPost]
        public ActionResult Create(V3_MilitaryPositionResponse obj)
        {
            var success = false;
            try
            {
                ...
                {
                    api.Insert(obj);
                    X.GetCmp<Store>("StoreMilitaryPosition").Reload();
        ...
        [HttpPost]
        public ActionResult Update(V3_MilitaryPositionResponse objEdit)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        public ActionResult Delete(int ID)
        {
            try
            {
                ...
                {
                    Ultility.ShowMessageBox("Không thành công", "Chức vụ quân đội đang được sử dụng", MessageBox.Icon.ERROR);
                }
                return this.Direct();
            }
            catch (Exception ex)
