...
{
    public class V3_PositionPartyController : Controller
    {
        V3_PartyPositionAPI api = new V3_PartyPositionAPI();
        // GET: Human/V3_PositionParty
        ...
        [HttpPost]
        public ActionResult Create(V3_PartyPositionResponse obj)
        {
            var success = false;
            try
            {
                ...
                {
                    api.Insert(obj);
                    X.GetCmp<Store>("StorePositionParty").Reload();
        ...
        [HttpPost]
        public ActionResult Update(V3_PartyPositionResponse objEdit)
        {
            try
            {
                if (ModelState.IsValid)
        ...
        public ActionResult Delete(int ID)
        {
            try
            {
                ...
                {
                    Ultility.ShowMessageBox("Không thành công", "Chức vụ đang được sử dụng", MessageBox.Icon.ERROR);
                }
                return this.Direct();
            }
            catch (Exception ex)
