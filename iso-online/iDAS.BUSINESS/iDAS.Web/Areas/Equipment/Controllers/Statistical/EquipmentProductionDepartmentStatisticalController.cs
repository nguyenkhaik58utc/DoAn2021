...
{
    [BaseSystem(Name = "Phân phối thiết bị sản xuất", Icon = "ChartPie", IsActive = true, IsShow = true, Position = 2, Parent = EquipmentStatisticalController.Code)]
    public class EquipmentProductionDepartmentStatisticalController : BaseController
    {
        //
        // GET: /Equipment/EquipmentProductionDepartmentStatistical/
        ...
        public ActionResult GetData(string node, string fromDate, string toDate,string depID)
        {
            ...
            var lsDataNodes = new EquipmentStatisticalSV().GenerateDataEquipmentProductionDepartmentStatistical(deptID, id, searchFromDate, searchToDate);
        ...
        public ActionResult ViewDetailStatistical(string urlStore = "", StoreParameter param = null, string fromDate = "", string toDate = "", int depId = 0)
        {
        ...
        public ActionResult renderTotal(StoreRequestParameters parameters, int cateId = 0,int depId=0, string fromDate = "", string toDate = "")
        {
            try
            {
                ...
                lst = new EquipmentProductionSV().GetByCategory_Department(filter, cateId,depId, searchFromDate, searchToDate);
        ...
        public ActionResult renderErrorsPass(StoreRequestParameters parameters, int cateId = 0, int depId = 0, string fromDate = "", string toDate = "")
        {
            try
            {
                ...
                searchToDate = !string.IsNullOrWhiteSpace(toDate) ? iDAS.Utilities.Convert.ToDateTime(toDate) : DateTime.Now;
                List<EquipmentProductionItem> lst = new List<EquipmentProductionItem>();
                lst = new EquipmentProductionSV().GetByCategory_DepartmentErrors(filter, cateId, depId, searchFromDate, searchToDate,true);
                return this.Store(lst, filter.PageTotal);
            }
            catch
            {
        ...
        public ActionResult renderErrNotPass(StoreRequestParameters parameters, int cateId = 0, int depId = 0, string fromDate = "", string toDate = "")
        {
            try
            {
                ...
                searchToDate = !string.IsNullOrWhiteSpace(toDate) ? iDAS.Utilities.Convert.ToDateTime(toDate) : DateTime.Now;
                List<EquipmentProductionItem> lst = new List<EquipmentProductionItem>();
                lst = new EquipmentProductionSV().GetByCategory_DepartmentErrors(filter, cateId, depId, searchFromDate, searchToDate,false);
                return this.Store(lst, filter.PageTotal);
            }
            catch
            {
        ...
        public ActionResult renderMaintainPass(StoreRequestParameters parameters, int cateId = 0, int depId = 0, string fromDate = "", string toDate = "")
        {
            try
            {
                ...
                searchToDate = !string.IsNullOrWhiteSpace(toDate) ? iDAS.Utilities.Convert.ToDateTime(toDate) : DateTime.Now;
                List<EquipmentProductionItem> lst = new List<EquipmentProductionItem>();
                lst = new EquipmentProductionSV().GetByCategory_DepartmentMaintain(filter, cateId, depId, searchFromDate, searchToDate,true);
                return this.Store(lst, filter.PageTotal);
            }
            catch
            {
        ...
        public ActionResult renderMaintainNotPass(StoreRequestParameters parameters, int cateId = 0, int depId = 0, string fromDate = "", string toDate = "")
        {
            try
            {
                ...
                searchToDate = !string.IsNullOrWhiteSpace(toDate) ? iDAS.Utilities.Convert.ToDateTime(toDate) : DateTime.Now;
                List<EquipmentProductionItem> lst = new List<EquipmentProductionItem>();
                lst = new EquipmentProductionSV().GetByCategory_DepartmentMaintain(filter, cateId, depId, searchFromDate, searchToDate, false);
                return this.Store(lst, filter.PageTotal);
            }
            catch
            {
