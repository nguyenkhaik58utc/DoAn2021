...
namespace iDAS.Web.Areas.Equipment.Controllers
{
    ...
    [BaseSystem(Name = "Nhóm Thiết Bị Đo", IsActive = true, IsShow = true, Position = 2, Icon = "Group", Parent = GroupCategoryController.Code)]
    public class EquipmentMeasureCategoryController : BaseController
    {
        private EquipmentMeasureCategorySV CategoryServices = new EquipmentMeasureCategorySV();
        ...
        public ActionResult Update(EquipmentMeasureCategoryItem data)
        {
            int id = 0;
            try
            {
        ...
        #region Xem chi tiết nhóm thiết bị đo
