...
namespace iDAS.Web.Areas.Customer.Controllers
{
    ...
    [BaseSystem(Name = "Khách hàng chưa tiếp cận", IsActive = true, Icon = "UserGray", IsShow = true, Position = 4)]
    public class CustomerBeginController : BaseController
    {
        ...
        public ActionResult LoadData(StoreRequestParameters parameters, int groupCustomerID = 0)
        {
            ...
            {
                result = customerSV.GetBeginCustomerByGroupID(filter, groupCustomerID, User.EmployeeID, User.Administrator);
            }
