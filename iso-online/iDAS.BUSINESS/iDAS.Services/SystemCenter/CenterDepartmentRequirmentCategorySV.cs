...
{
    public class CenterDepartmentRequirmentCategorySV
    {
        private CenterDepartmentRequirmentCategoryDA DepartmentRequirmentCategoryDA = new CenterDepartmentRequirmentCategoryDA();
        ...
        public void Update(CenterDepartmentRequirmentCategoryItem item, int userID)
        {
        ...
        public int Insert(CenterDepartmentRequirmentCategoryItem item, int userID)
        {
