...
{
    public class CenterDepartmentRequirmentSV
    {
        private CenterDepartmentRequirmentDA DepartmentRequirmentDA = new CenterDepartmentRequirmentDA();
        public List<CenterDepartmentRequirmentItem> GetAll(int page, int pageSize, out int totalCount)
        {
            var DepartmentRequirment = DepartmentRequirmentDA.GetQuery()
                        .Select(item => new CenterDepartmentRequirmentItem()
                        {
                            ID = item.ID,
        ...
        public List<CenterDepartmentRequirmentItem> GetRequirmentIn(int page, int pageSize, out int totalCount)
        {
        ...
        public List<CenterDepartmentRequirmentItem> GetRequirmentOut(int page, int pageSize, out int totalCount)
        {
            var DepartmentRequirment = DepartmentRequirmentDA.GetQuery(i => !i.IsInner)
                        .Select(item => new CenterDepartmentRequirmentItem()
                        {
        ...
        public CenterDepartmentRequirmentItem GetById(int Id)
        {
        ...
        public void Update(CenterDepartmentRequirmentItem item, int userID)
        {
        ...
        public int Insert(CenterDepartmentRequirmentItem item, int userID)
        {
