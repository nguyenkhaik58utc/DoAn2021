...
namespace iDAS.Services
{
    ...
    /// </summary>
    public class v3_PermissionSV : BaseService
    {
        ...
        public List<HumanDepartment> GetAllDepartment()
        {
            var data = new List<HumanDepartment>();
            
            // To do: Get data from Database here.

            return data.ToList();
        }

        // HungNM. Get data for combobox Title.
        // sua bang HumanDepartment thanh bang V3OrgTitles
        public List<HumanDepartment> GetAllTitle(int id)
        {
            var data = new List<HumanDepartment>();
