...
namespace iDAS.Web.Areas.ISO.Controllers
{
    ...
    [BaseSystem(Name = "Nội bộ", IsActive = true, Icon = "PackageDown", IsShow = true, Position = 1, Parent = DepartmentContextController.Code)]
    public class RequirmentInController : BaseController
    {
        ...
        {
            int totalCount;
            var result = RequirmentSV.GetRequirmentIn(parameters.Page, parameters.Limit, out totalCount);
