...
{
    [BaseSystem(Name = "Lĩnh vực ngành nghề", IsActive = true, IsShow = true, Icon = "Basket", Position = 3, Parent = "GroupProduct")]
    [SystemAuthorize(CheckAuthorize = false)]
    public class ProductScopeController : BaseController
    {
        private ProductScopeSV service = new ProductScopeSV();
        ...
        public ActionResult LoadData(StoreRequestParameters parameters)
        {
            ...
            {
                int total = 0;
                var data = service.GetProductScopes(parameters.Page, parameters.Limit, out total);
        ...
        [HttpPost]
        public ActionResult Create(ProductScopeItem item)
        {
            var result = false;
            try
            {
        ...
        [BaseSystem(Name = "Sửa")]
        [SystemAuthorize(CheckAuthorize = true)]
        public ActionResult Update(int productScopeId)
        {
            try
            {
                var data = service.GetProductScope(productScopeId);
        ...
        [HttpPost]
        public ActionResult Update(ProductScopeItem item)
        {
            var result = false;
            try
            {
        ...
        [HttpPost]
        public ActionResult Delete(int productScopeId = 0)
        {
            try
            {
                service.Delete(productScopeId);
        ...
        [SystemAuthorize(CheckAuthorize = true)]
        public ActionResult Detail(int productScopeId)
        {
            try
            {
                var data = service.GetProductScope(productScopeId);
