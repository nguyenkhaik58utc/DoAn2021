...
namespace iDAS.Web
{
    public class Ultility 
    {
        ...
        public static void SetIconUrl<T>(List<T> source) where T : BaseSystemItem
        {
            foreach (var item in source) {
        ...
        public static void SetIconName<T>(T item) where T : BaseSystemItem 
        {
            item.IconName = GetIconName(item.IconUrl);
        }

        public static List<IconItem> GetIcons()
        {
